...
public class GetAllOrdersRequestHandlerTests
{
    private readonly Mock<IOrderRepository> _orderRepositoryMock = new();
    private readonly Mock<IMapper> _mapperMock = new();
    private readonly IOptions<PaginationSettings> _paginationOptions;
    private readonly Fixture _fixture = new();
    private readonly GetAllOrdersRequestHandler _handler;
    ...
    public GetAllOrdersRequestHandlerTests()
    {
        ...
        _handler = new GetAllOrdersRequestHandler(
    ...
    {
        //Arrange
        var request = new GetAllOrdersRequest { PageNo = 3, PageSize = 10 };
    ...
    {
        //Arrange
        var request = new GetAllOrdersRequest { PageNo = 1, PageSize = 10 };
    ...
    public async Task Handle_WhenPageSizeExceedsMaxPageSize_ShouldUseMaxPageSize()
    {
        ...
        var request = new GetAllOrdersRequest { PageNo = 1, PageSize = maxPageSize * 10 + 10 };

        _orderRepositoryMock.Setup(repo => repo.ListWithPaginationAsync(request.PageNo, It.IsAny<int>(), It.IsAny<CancellationToken>()))
