...
namespace OrderService.Tests.UnitTests.Middleware;
...
public class ExceptionMiddlewareTests
{
    ...
    [Fact]
    public async Task InvokeAsync_WhenAccessDeniedExceptionThrown_ShouldReturnForbidden()
    {
        //Arrange
        var context = new DefaultHttpContext();
    ...
    [Fact]
    public async Task InvokeAsync_WhenRpcExceptionThrown_ShouldReturnBadRequest()
    {
        //Arrange
        var context = new DefaultHttpContext();
        var exception = new RpcException(It.IsAny<Status>());
        _nextMock.Setup(m => m(It.IsAny<HttpContext>())).ThrowsAsync(exception);
