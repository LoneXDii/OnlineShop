...
public class AddCategoryDtoValidatorTests
{
    ...
    {
        //Arrange
        var categoryDto = new AddCategoryDTO { Name = string.Empty, Image = null };
    ...
    public void Validate_WhenImageIsNotAnImageFile_ShouldReturnFalseWithCorrectErrorMessage()
    {
        ...
        var categoryDto = new AddCategoryDTO { Name = "Valid Name", Image = _formFileMock.Object };
    ...
    {
        //Arrange
        var categoryDto = new AddCategoryDTO { Name = "Valid Name", Image = null };
