...
public class AddProductDtoValidatorTests
{
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = string.Empty, Price = 10, Quantity = 1, Attributes = [] };
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = "Valid Product", Price = -1, Quantity = 1, Attributes = [] };
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = "Valid Product", Price = 0, Quantity = 1, Attributes = [] };
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = "Valid Product", Price = 10, Quantity = -1, Attributes = [] };
    ...
    public void Validate_WhenImageIsNotAnImageFile_ShouldReturnFalseWithCorrectErrorMessage()
    {
        ...
        var request = new AddProductDTO { Name = "Valid Product", Price = 10, Quantity = 1, Image = fileMock.Object, Attributes = [] };
    ...
    [Fact]
    public void Validate_WhenImageIsAnImageFile_ShouldReturnTrueWithNoErrors()
    {
        //Arrange
        var fileMock = new Mock<IFormFile>();
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = "Valid Product", Price = 10, Quantity = 1, Image = null, Attributes = [] };
    ...
    {
        //Arrange
        var request = new AddProductDTO { Name = "Valid Product", Price = 10, Quantity = 1, Attributes = [1, 0, -2] };
